...
<div class="ts-group">
	<div class="x-row">
		<?php \Voxel\Utils\Form_Models\Switcher_Model::render( [
			'v-model' => 'settings.promotions.enabled',
			'label' => 'Enable promoted listings',
			'classes' => 'x-col-12',
		] ) ?>

		<!-- <div class="x-col-12">
			<pre debug>{{ settings.promotions }}</pre>
		</div> -->
	</div>
</div>

<template v-if="settings.promotions.enabled">
	<div class="ts-group">
		...
		<div class="x-row">
			<?php \Voxel\Utils\Form_Models\Select_Model::render( [
				'v-model' => 'settings.promotions.payments.mode',
				'label' => 'Payment mode',
				'classes' => 'x-col-12',
				'choices' => [
			...
			<?php \Voxel\Utils\Form_Models\Select_Model::render( [
				'v-model' => 'settings.promotions.order_approval',
	...
	<div class="ts-group">
		...
		<div class="x-row">
			<div class="x-col-12 field-container ts-drag-animation">
				<template v-if="settings.promotions.packages.length">
					<draggable
						v-model="settings.promotions.packages"
							...
							<div class="single-field wide" :class="{open: state.activePromoPackage === package}">
								<div class="field-head" @click="state.activePromoPackage = state.activePromoPackage === package ? null : package">
									...
									<div class="field-actions">
										<span class="field-action all-center">
											<a href="#" @click.prevent="settings.promotions.packages.splice(index, 1)">
								...
								<div v-if="state.activePromoPackage === package" class="field-body">
									<div class="x-row">
										...
										<?php \Voxel\Utils\Form_Models\Color_Model::render( [
											'v-model' => 'package.ui.color',
											'label' => 'Accent color',
											'classes' => 'x-col-6',
										] ) ?>

										<?php \Voxel\Utils\Form_Models\Icon_Model::render( [
			...
			<div class="x-col-12">
				<div class="add-field">
					<div
						...
						@click.prevent="settings.promotions.packages.push( {
