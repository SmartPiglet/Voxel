...
namespace Voxel\Vendor\Stripe\V2;
 ...
 */
class Collection extends \Voxel\Vendor\Stripe\StripeObject implements \Countable, \IteratorAggregate
{
    const OBJECT_NAME = 'list';
    use \Voxel\Vendor\Stripe\ApiOperations\Request;
    /**
     * @return string the base URL for the given class
     */
    public static function baseUrl()
    {
        return \Voxel\Vendor\Stripe\Stripe::$apiBase;
    }
    /**
     * @return mixed
     */
    ...
    public function autoPagingIterator()
    {
        ...
        while (\true) {
            ...
            $obj = \Voxel\Vendor\Stripe\Util\Util::convertToStripeObject($response, $opts, 'v2');
