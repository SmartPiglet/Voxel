...
use Voxel\Vendor\NXP\Exception\IncorrectBracketsException;
use Voxel\Vendor\NXP\Exception\UnknownOperatorException;
...
class Tokenizer
{
    ...
    private bool $allowNegative = \true;
        ...
        foreach (\str_split($this->input) as $ch) {
            switch (\true) {
                ...
                case $this->isAlpha($ch):
                    ...
                    break;
                case '"' == $ch:
                    $this->inDoubleQuotedString = \true;
                    continue 2;
                case "'" == $ch:
                    $this->inSingleQuotedString = \true;
                    continue 2;
                case $this->isDot($ch):
                    $this->numberBuffer .= $ch;
                    $this->allowNegative = \false;
