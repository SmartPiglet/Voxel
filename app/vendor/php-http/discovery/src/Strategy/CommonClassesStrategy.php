...
use Voxel\Vendor\GuzzleHttp\Client as GuzzleHttp;
use Voxel\Vendor\GuzzleHttp\Promise\Promise;
use Voxel\Vendor\GuzzleHttp\Psr7\Request as GuzzleRequest;
use Voxel\Vendor\Http\Adapter\Artax\Client as Artax;
use Voxel\Vendor\Http\Adapter\Buzz\Client as Buzz;
use Voxel\Vendor\Http\Adapter\Cake\Client as Cake;
use Voxel\Vendor\Http\Adapter\Guzzle5\Client as Guzzle5;
use Voxel\Vendor\Http\Adapter\Guzzle6\Client as Guzzle6;
use Voxel\Vendor\Http\Adapter\Guzzle7\Client as Guzzle7;
use Voxel\Vendor\Http\Adapter\React\Client as React;
use Voxel\Vendor\Http\Client\Curl\Client as Curl;
use Voxel\Vendor\Http\Client\HttpAsyncClient;
use Voxel\Vendor\Http\Client\HttpClient;
use Voxel\Vendor\Http\Client\Socket\Client as Socket;
use Voxel\Vendor\Http\Discovery\ClassDiscovery;
use Voxel\Vendor\Http\Discovery\Exception\NotFoundException;
use Voxel\Vendor\Http\Discovery\Psr17FactoryDiscovery;
use Voxel\Vendor\Http\Message\MessageFactory;
use Voxel\Vendor\Http\Message\MessageFactory\DiactorosMessageFactory;
use Voxel\Vendor\Http\Message\MessageFactory\GuzzleMessageFactory;
use Voxel\Vendor\Http\Message\MessageFactory\SlimMessageFactory;
use Voxel\Vendor\Http\Message\StreamFactory;
use Voxel\Vendor\Http\Message\StreamFactory\DiactorosStreamFactory;
use Voxel\Vendor\Http\Message\StreamFactory\GuzzleStreamFactory;
use Voxel\Vendor\Http\Message\StreamFactory\SlimStreamFactory;
use Voxel\Vendor\Http\Message\UriFactory;
use Voxel\Vendor\Http\Message\UriFactory\DiactorosUriFactory;
use Voxel\Vendor\Http\Message\UriFactory\GuzzleUriFactory;
use Voxel\Vendor\Http\Message\UriFactory\SlimUriFactory;
use Voxel\Vendor\Laminas\Diactoros\Request as DiactorosRequest;
use Voxel\Vendor\Nyholm\Psr7\Factory\HttplugFactory as NyholmHttplugFactory;
use Voxel\Vendor\Psr\Http\Client\ClientInterface as Psr18Client;
use Voxel\Vendor\Psr\Http\Message\RequestFactoryInterface as Psr17RequestFactory;
use Voxel\Vendor\Slim\Http\Request as SlimRequest;
use Voxel\Vendor\Symfony\Component\HttpClient\HttplugClient as SymfonyHttplug;
use Voxel\Vendor\Symfony\Component\HttpClient\Psr18Client as SymfonyPsr18;
/**
 * @internal
 *
...
final class CommonClassesStrategy implements DiscoveryStrategy
{
    ...
    {
        return new \Voxel\Vendor\Buzz\Client\FileGetContents(Psr17FactoryDiscovery::findResponseFactory());
    }
    ...
    {
        return defined('Voxel\Vendor\GuzzleHttp\ClientInterface::MAJOR_VERSION');
    }
