...
namespace Voxel\Vendor\Http\Discovery\Composer;

use Voxel\Vendor\Composer\Composer;
use Voxel\Vendor\Composer\DependencyResolver\Pool;
use Voxel\Vendor\Composer\EventDispatcher\EventSubscriberInterface;
use Voxel\Vendor\Composer\Factory;
use Voxel\Vendor\Composer\Installer;
use Voxel\Vendor\Composer\IO\IOInterface;
use Voxel\Vendor\Composer\Json\JsonFile;
use Voxel\Vendor\Composer\Json\JsonManipulator;
use Voxel\Vendor\Composer\Package\Locker;
use Voxel\Vendor\Composer\Package\Version\VersionParser;
use Voxel\Vendor\Composer\Package\Version\VersionSelector;
use Voxel\Vendor\Composer\Plugin\PluginInterface;
use Voxel\Vendor\Composer\Repository\InstalledRepositoryInterface;
use Voxel\Vendor\Composer\Repository\RepositorySet;
use Voxel\Vendor\Composer\Script\Event;
use Voxel\Vendor\Composer\Script\ScriptEvents;
use Voxel\Vendor\Composer\Util\Filesystem;
...
class Plugin implements PluginInterface, EventSubscriberInterface
{
    ...
    private const INTERFACE_MAP = ['php-http/async-client-implementation' => ['Voxel\Vendor\Http\Client\HttpAsyncClient'], 'php-http/client-implementation' => ['Voxel\Vendor\Http\Client\HttpClient'], 'psr/http-client-implementation' => ['Voxel\Vendor\Psr\Http\Client\ClientInterface'], 'psr/http-factory-implementation' => ['Voxel\Vendor\Psr\Http\Message\RequestFactoryInterface', 'Voxel\Vendor\Psr\Http\Message\ResponseFactoryInterface', 'Voxel\Vendor\Psr\Http\Message\ServerRequestFactoryInterface', 'Voxel\Vendor\Psr\Http\Message\StreamFactoryInterface', 'Voxel\Vendor\Psr\Http\Message\UploadedFileFactoryInterface', 'Voxel\Vendor\Psr\Http\Message\UriFactoryInterface']];
    ...
    public function getMissingRequires(InstalledRepositoryInterface $repo, array $requires, bool $isProject, array $pinnedAbstractions): array
    {
        ...
        if (ClassDiscovery::safeClassExists(\Voxel\Vendor\Phalcon\Http\Message\RequestFactory::class, \false)) {
