...
namespace Voxel\Vendor\Http\Discovery;

use Voxel\Vendor\Http\Discovery\Exception\ClassInstantiationFailedException;
use Voxel\Vendor\Http\Discovery\Exception\DiscoveryFailedException;
use Voxel\Vendor\Http\Discovery\Exception\NoCandidateFoundException;
use Voxel\Vendor\Http\Discovery\Exception\StrategyUnavailableException;
use Voxel\Vendor\Http\Discovery\Strategy\DiscoveryStrategy;
/**
