...
use Voxel\Vendor\Symfony\Component\Console\Completion\CompletionInput;
use Voxel\Vendor\Symfony\Component\Console\Completion\CompletionSuggestions;
use Voxel\Vendor\Symfony\Component\Console\Input\InputInterface;
use Voxel\Vendor\Symfony\Component\Console\Input\InputOption;
...
use Voxel\Vendor\Symfony\Component\Uid\Exception\LogicException;
use Voxel\Vendor\Symfony\Component\Uid\Factory\UuidFactory;
...
{
    public function __construct(private UuidFactory $factory = new UuidFactory())
    {
        parent::__construct();
    }
...
EOF
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        if (\in_array($formatOption, $this->getAvailableFormatOptions(), \true)) {
