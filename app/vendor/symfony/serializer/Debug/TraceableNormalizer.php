 ...
 */
namespace Voxel\Vendor\Symfony\Component\Serializer\Debug;

use Voxel\Vendor\Symfony\Component\Serializer\DataCollector\SerializerDataCollector;
...
{
    public function __construct(private NormalizerInterface|DenormalizerInterface $normalizer, private SerializerDataCollector $dataCollector, private readonly string $serializerName = 'default')
    {
    }
