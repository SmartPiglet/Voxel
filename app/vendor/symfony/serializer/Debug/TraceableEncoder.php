...
use Voxel\Vendor\Symfony\Component\Serializer\Encoder\NormalizationAwareInterface;
...
{
    public function __construct(private EncoderInterface|DecoderInterface $encoder, private SerializerDataCollector $dataCollector, private readonly string $serializerName = 'default')
    {
    }
