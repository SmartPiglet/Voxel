 ...
 */
namespace Voxel\Vendor\Symfony\Component\Serializer\Mapping;
...
class ClassDiscriminatorMapping
{
     ...
     */
    public function __construct(private readonly string $typeProperty, private array $typesMapping = [], private readonly ?string $defaultType = null)
    {
