...
use Voxel\Vendor\Symfony\Component\Config\Util\XmlUtils;
    ...
    public function loadClassMetadata(ClassMetadataInterface $classMetadata): bool
    {
        ...
        if (isset($this->classes[$classMetadata->getName()])) {
            ...
            if (isset($xml->{'discriminator-map'})) {
                ...
                $classMetadata->setClassDiscriminatorMapping(new ClassDiscriminatorMapping((string) $xml->{'discriminator-map'}->attributes()->{'type-property'}, $mapping, $xml->{'discriminator-map'}->attributes()->{'default-type'} ?? null));
            }
            return \true;
        }
        return \false;
