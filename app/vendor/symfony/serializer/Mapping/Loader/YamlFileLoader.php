...
use Voxel\Vendor\Symfony\Component\Yaml\Parser;
use Voxel\Vendor\Symfony\Component\Yaml\Yaml;
/**
 * YAML File Loader.
 *
...
class YamlFileLoader extends FileLoader
{
    ...
    public function loadClassMetadata(ClassMetadataInterface $classMetadata): bool
    {
        ...
        if (isset($yaml['discriminator_map'])) {
            ...
            $classMetadata->setClassDiscriminatorMapping(new ClassDiscriminatorMapping($yaml['discriminator_map']['type_property'], $yaml['discriminator_map']['mapping'], $yaml['discriminator_map']['default_type'] ?? null));
        }
        return \true;
    }
    /**
