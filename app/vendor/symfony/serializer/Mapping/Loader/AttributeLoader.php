 ...
 */
namespace Voxel\Vendor\Symfony\Component\Serializer\Mapping\Loader;

use Voxel\Vendor\Symfony\Component\Serializer\Attribute\Context;
use Voxel\Vendor\Symfony\Component\Serializer\Attribute\DiscriminatorMap;
use Voxel\Vendor\Symfony\Component\Serializer\Attribute\Groups;
use Voxel\Vendor\Symfony\Component\Serializer\Attribute\Ignore;
use Voxel\Vendor\Symfony\Component\Serializer\Attribute\MaxDepth;
use Voxel\Vendor\Symfony\Component\Serializer\Attribute\SerializedName;
use Voxel\Vendor\Symfony\Component\Serializer\Attribute\SerializedPath;
use Voxel\Vendor\Symfony\Component\Serializer\Exception\MappingException;
...
use Voxel\Vendor\Symfony\Component\Serializer\Mapping\ClassDiscriminatorMapping;
            ...
            if ($property->getDeclaringClass()->name === $className) {
                ...
                foreach ($this->loadAttributes($property) as $attribute) {
                    ...
                    match (\true) {
                        ...
                        $attribute instanceof Ignore => $attributeMetadata->setIgnore(\true),
