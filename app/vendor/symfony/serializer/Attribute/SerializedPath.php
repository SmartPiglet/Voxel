...
if (!class_exists(\Voxel\Vendor\Symfony\Component\Serializer\Annotation\SerializedPath::class, \false)) {
    class_alias(SerializedPath::class, \Voxel\Vendor\Symfony\Component\Serializer\Annotation\SerializedPath::class);
}
