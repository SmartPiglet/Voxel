...
class DiscriminatorMap
{
     ...
     */
    public function __construct(private readonly string $typeProperty, private readonly array $mapping, private readonly ?string $defaultType = null)
    {
        if (!$typeProperty) {
...
if (!class_exists(\Voxel\Vendor\Symfony\Component\Serializer\Annotation\DiscriminatorMap::class, \false)) {
    class_alias(DiscriminatorMap::class, \Voxel\Vendor\Symfony\Component\Serializer\Annotation\DiscriminatorMap::class);
}
