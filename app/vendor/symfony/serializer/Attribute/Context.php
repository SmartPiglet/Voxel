...
if (!class_exists(\Voxel\Vendor\Symfony\Component\Serializer\Annotation\Context::class, \false)) {
    class_alias(Context::class, \Voxel\Vendor\Symfony\Component\Serializer\Annotation\Context::class);
}
