...
if (!class_exists(\Voxel\Vendor\Symfony\Component\Serializer\Annotation\Groups::class, \false)) {
    class_alias(Groups::class, \Voxel\Vendor\Symfony\Component\Serializer\Annotation\Groups::class);
}
