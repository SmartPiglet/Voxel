 ...
 */
namespace Voxel\Vendor\Symfony\Component\Serializer\NameConverter;

use Voxel\Vendor\Symfony\Component\Serializer\Exception\UnexpectedPropertyException;
/**
...
final readonly class SnakeCaseToCamelCaseNameConverter implements NameConverterInterface
{
    ...
    {
        if (null !== $this->attributes && !\in_array($propertyName, $this->attributes, \true)) {
            return $propertyName;
        }
    ...
    public function denormalize(string $propertyName, ?string $class = null, ?string $format = null, array $context = []): string
    {
        ...
        if (null === $this->attributes || \in_array($snakeCased, $this->attributes, \true)) {
            return $snakeCased;
        }
        return $propertyName;
    }
