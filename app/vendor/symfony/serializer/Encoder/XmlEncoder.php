 ...
 */
namespace Voxel\Vendor\Symfony\Component\Serializer\Encoder;

use Voxel\Vendor\Symfony\Component\Serializer\Exception\BadMethodCallException;
use Voxel\Vendor\Symfony\Component\Serializer\Exception\NotEncodableValueException;
...
class XmlEncoder implements EncoderInterface, DecoderInterface, NormalizationAwareInterface, SerializerAwareInterface
{
    ...
    private array $defaultContext = [self::AS_COLLECTION => \false, self::DECODER_IGNORED_NODE_TYPES => [\XML_PI_NODE, \XML_COMMENT_NODE], self::ENCODER_IGNORED_NODE_TYPES => [], self::LOAD_OPTIONS => \LIBXML_NONET | \LIBXML_NOBLANKS, self::SAVE_OPTIONS => 0, self::REMOVE_EMPTY_TAGS => \false, self::ROOT_NODE_NAME => 'response', self::TYPE_CAST_ATTRIBUTES => \true, self::CDATA_WRAPPING => \true, self::CDATA_WRAPPING_PATTERN => '/[<>&]/', self::IGNORE_EMPTY_ATTRIBUTES => \false];
