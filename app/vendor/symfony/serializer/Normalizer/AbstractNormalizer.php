...
use Voxel\Vendor\Symfony\Component\Serializer\Exception\CircularReferenceException;
...
use Voxel\Vendor\Symfony\Component\Serializer\Exception\RuntimeException;
...
use Voxel\Vendor\Symfony\Component\Serializer\SerializerAwareInterface;
use Voxel\Vendor\Symfony\Component\Serializer\SerializerAwareTrait;
/**
...
abstract class AbstractNormalizer implements NormalizerInterface, DenormalizerInterface, SerializerAwareInterface
{
    ...
    protected array $defaultContext = [self::ALLOW_EXTRA_ATTRIBUTES => \true, self::CIRCULAR_REFERENCE_HANDLER => null, self::CIRCULAR_REFERENCE_LIMIT => 1, self::IGNORED_ATTRIBUTES => []];
    /**
     * Sets the {@link ClassMetadataFactoryInterface} to use.
     */
    public function __construct(protected ?ClassMetadataFactoryInterface $classMetadataFactory = null, protected ?NameConverterInterface $nameConverter = null, array $defaultContext = [])
    {
    ...
    protected function getAllowedAttributes(string|object $classOrObject, array $context, bool $attributesAsString = \false): array|bool
    {
        ...
        foreach ($this->classMetadataFactory->getMetadataFor($classOrObject)->getAttributesMetadata() as $attributeMetadata) {
            ...
            if (!$ignore && ([] === $groups || \in_array('*', $groups, \true) || array_intersect($attributeMetadata->getGroups(), $groups)) && $this->isAllowedAttribute($classOrObject, $name = $attributeMetadata->getName(), null, $context)) {
    ...
    protected function isAllowedAttribute(object|string $classOrObject, string $attribute, ?string $format = null, array $context = []): bool
    {
        ...
        if (\in_array($attribute, $ignoredAttributes, \true)) {
            return \false;
        }
    ...
    protected function instantiateObject(array &$data, string $class, array &$context, \ReflectionClass $reflectionClass, array|bool $allowedAttributes, ?string $format = null): object
    {
        ...
        if ($constructor) {
            ...
            foreach ($constructorParameters as $constructorParameter) {
                ...
                $allowed = \false === $allowedAttributes || \in_array($paramName, $allowedAttributes, \true);
                ...
                if ($constructorParameter->isVariadic()) {
                    ...
                    $exception = NotNormalizableValueException::createForUnexpectedDataType(\sprintf('Failed to create object because the class misses the "%s" property.', $constructorParameter->name), null, [$constructorParameterType], $attributeContext['deserialization_path'] ?? null, \true);
                    $context['not_normalizable_value_exceptions'][] = $exception;
                }
            }
