...
use Voxel\Vendor\Symfony\Component\PropertyAccess\PropertyAccessorInterface;
use Voxel\Vendor\Symfony\Component\PropertyInfo\Extractor\ReflectionExtractor;
use Voxel\Vendor\Symfony\Component\PropertyInfo\PropertyInfoExtractorInterface;
...
use Voxel\Vendor\Symfony\Component\Serializer\Annotation\Ignore;
    ...
    protected function isAllowedAttribute($classOrObject, string $attribute, ?string $format = null, array $context = []): bool
    {
        ...
        if (!isset(self::$isWritableCache[$class . $attribute])) {
            if (str_contains($attribute, '.')) {
                self::$isWritableCache[$class . $attribute] = \true;
            } else {
