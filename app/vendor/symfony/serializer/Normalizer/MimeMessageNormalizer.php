...
use Voxel\Vendor\Symfony\Component\Mime\Address;
use Voxel\Vendor\Symfony\Component\Mime\Header\HeaderInterface;
use Voxel\Vendor\Symfony\Component\Mime\Header\Headers;
use Voxel\Vendor\Symfony\Component\Mime\Header\UnstructuredHeader;
use Voxel\Vendor\Symfony\Component\Mime\Message;
use Voxel\Vendor\Symfony\Component\Mime\Part\AbstractPart;
use Voxel\Vendor\Symfony\Component\Mime\RawMessage;
...
final class MimeMessageNormalizer implements NormalizerInterface, DenormalizerInterface, SerializerAwareInterface
{
    ...
    {
        return [Message::class => \true, Headers::class => \true, HeaderInterface::class => \true, Address::class => \true, AbstractPart::class => \true];
    }
