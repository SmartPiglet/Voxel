 ...
 */
namespace Voxel\Vendor\Symfony\Contracts\HttpClient\Test;

use Voxel\Vendor\PHPUnit\Framework\Attributes\RequiresPhpExtension;
use Voxel\Vendor\PHPUnit\Framework\TestCase;
...
use Voxel\Vendor\Symfony\Contracts\HttpClient\Exception\TimeoutExceptionInterface;
...
abstract class HttpClientTestCase extends TestCase
{
    ...
    {
        if (!\function_exists('ob_gzhandler') && !\function_exists('Voxel\Vendor\ob_gzhandler')) {
