...
use Voxel\Vendor\phpDocumentor\Reflection\Types\ContextFactory;
use Voxel\Vendor\PHPStan\PhpDocParser\Ast\PhpDoc\InvalidTagValueNode;
use Voxel\Vendor\PHPStan\PhpDocParser\Ast\PhpDoc\ParamTagValueNode;
use Voxel\Vendor\PHPStan\PhpDocParser\Ast\PhpDoc\PhpDocChildNode;
use Voxel\Vendor\PHPStan\PhpDocParser\Ast\PhpDoc\PhpDocNode;
use Voxel\Vendor\PHPStan\PhpDocParser\Ast\PhpDoc\PhpDocTagNode;
use Voxel\Vendor\PHPStan\PhpDocParser\Ast\PhpDoc\PhpDocTextNode;
use Voxel\Vendor\PHPStan\PhpDocParser\Ast\PhpDoc\ReturnTagValueNode;
use Voxel\Vendor\PHPStan\PhpDocParser\Ast\PhpDoc\VarTagValueNode;
...
use Voxel\Vendor\Symfony\Component\PropertyInfo\PropertyDescriptionExtractorInterface;
...
use Voxel\Vendor\Symfony\Component\PropertyInfo\Util\PhpStanTypeHelper;
...
final class PhpStanExtractor implements PropertyDescriptionExtractorInterface, PropertyTypeExtractorInterface, ConstructorArgumentTypeExtractorInterface
{
     ...
     */
    public function __construct(?array $mutatorPrefixes = null, ?array $accessorPrefixes = null, ?array $arrayMutatorPrefixes = null, private bool $allowPrivateAccess = \true)
    {
    ...
    public function getTypes(string $class, string $property, array $context = []): ?array
    {
        ...
        return [new LegacyType(LegacyType::BUILTIN_TYPE_ARRAY, \false, null, \true, new LegacyType(LegacyType::BUILTIN_TYPE_INT), $types[0])];
    }
    /**
    ...
    private function getDescriptionsFromDocNode(PhpDocNode $docNode): array
    {
        ...
        return [$shortDescription ?: null, $longDescription ?: null];
    }
    ...
    private function getDocBlockFromMethod(string $class, string $ucFirstProperty, int $type): ?array
    {
        ...
        foreach ($prefixes as $prefix) {
            ...
            try {
                ...
                if ((self::ACCESSOR === $type && 0 === $reflectionMethod->getNumberOfRequiredParameters() || self::MUTATOR === $type && $reflectionMethod->getNumberOfParameters() >= 1) && $this->canAccessMemberBasedOnItsVisibility($reflectionMethod)) {
                    break;
                }
            } catch (\ReflectionException) {
