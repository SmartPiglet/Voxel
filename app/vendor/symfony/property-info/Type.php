 ...
 */
namespace Voxel\Vendor\Symfony\Component\PropertyInfo;

trigger_deprecation('symfony/property-info', '7.3', 'The "%s" class is deprecated. Use "%s" class from "symfony/type-info" instead.', Type::class, \Voxel\Vendor\Symfony\Component\TypeInfo\Type::class);
/**
...
class Type
{
     ...
     * @var string[]
     */
    public static array $builtinCollectionTypes = [self::BUILTIN_TYPE_ARRAY, self::BUILTIN_TYPE_ITERABLE];
     ...
     */
    public function __construct(private string $builtinType, private bool $nullable = \false, private ?string $class = null, private bool $collection = \false, array|self|null $collectionKeyType = null, array|self|null $collectionValueType = null)
    {
        if (!\in_array($builtinType, self::$builtinTypes, \true)) {
