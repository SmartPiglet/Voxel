 ...
 */
namespace Voxel\Vendor\Symfony\Component\PropertyAccess;

use Voxel\Vendor\Psr\Cache\CacheItemPoolInterface;
use Voxel\Vendor\Psr\Log\LoggerInterface;
use Voxel\Vendor\Psr\Log\NullLogger;
use Voxel\Vendor\Symfony\Component\Cache\Adapter\AdapterInterface;
use Voxel\Vendor\Symfony\Component\Cache\Adapter\ApcuAdapter;
use Voxel\Vendor\Symfony\Component\Cache\Adapter\NullAdapter;
use Voxel\Vendor\Symfony\Component\PropertyAccess\Exception\AccessException;
use Voxel\Vendor\Symfony\Component\PropertyAccess\Exception\InvalidTypeException;
use Voxel\Vendor\Symfony\Component\PropertyAccess\Exception\NoSuchIndexException;
use Voxel\Vendor\Symfony\Component\PropertyAccess\Exception\NoSuchPropertyException;
use Voxel\Vendor\Symfony\Component\PropertyAccess\Exception\UnexpectedTypeException;
use Voxel\Vendor\Symfony\Component\PropertyAccess\Exception\UninitializedPropertyException;
use Voxel\Vendor\Symfony\Component\PropertyInfo\Extractor\ReflectionExtractor;
...
class PropertyAccessor implements PropertyAccessorInterface
{
     ...
     */
    public function __construct(private int $magicMethodsFlags = self::MAGIC_GET | self::MAGIC_SET, int $throw = self::THROW_ON_INVALID_PROPERTY_PATH, ?CacheItemPoolInterface $cacheItemPool = null, ?PropertyReadInfoExtractorInterface $readInfoExtractor = null, ?PropertyWriteInfoExtractorInterface $writeInfoExtractor = null)
    {
