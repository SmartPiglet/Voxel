 ...
 */
use Voxel\Vendor\Symfony\Polyfill\Intl\Grapheme as p;
...
if (!\function_exists('grapheme_extract') && !\function_exists('Voxel\Vendor\grapheme_extract')) {
...
if (!\function_exists('grapheme_stripos') && !\function_exists('Voxel\Vendor\grapheme_stripos')) {
...
if (!\function_exists('grapheme_stristr') && !\function_exists('Voxel\Vendor\grapheme_stristr')) {
...
if (!\function_exists('grapheme_strlen') && !\function_exists('Voxel\Vendor\grapheme_strlen')) {
    function grapheme_strlen(?string $string): int|false|null
    {
        return p\Grapheme::grapheme_strlen((string) $string);
    }
}
if (!\function_exists('grapheme_strpos') && !\function_exists('Voxel\Vendor\grapheme_strpos')) {
...
if (!\function_exists('grapheme_strripos') && !\function_exists('Voxel\Vendor\grapheme_strripos')) {
...
if (!\function_exists('grapheme_strrpos') && !\function_exists('Voxel\Vendor\grapheme_strrpos')) {
...
if (!\function_exists('grapheme_strstr') && !\function_exists('Voxel\Vendor\grapheme_strstr')) {
...
if (!\function_exists('grapheme_substr') && !\function_exists('Voxel\Vendor\grapheme_substr')) {
