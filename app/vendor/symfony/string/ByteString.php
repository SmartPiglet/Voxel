 ...
 */
namespace Voxel\Vendor\Symfony\Component\String;

use Random\Randomizer;
use Voxel\Vendor\Symfony\Component\String\Exception\ExceptionInterface;
use Voxel\Vendor\Symfony\Component\String\Exception\InvalidArgumentException;
use Voxel\Vendor\Symfony\Component\String\Exception\RuntimeException;
/**
    ...
    public function toCodePointString(?string $fromEncoding = null): CodePointString
    {
        ...
        try {
            try {
                ...
                if (!\function_exists('iconv') && !\function_exists('Voxel\Vendor\iconv')) {
                    throw $e;
                }
