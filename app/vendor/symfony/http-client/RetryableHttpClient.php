...
use Voxel\Vendor\Symfony\Component\HttpClient\Retry\GenericRetryStrategy;
use Voxel\Vendor\Symfony\Component\HttpClient\Retry\RetryStrategyInterface;
...
class RetryableHttpClient implements HttpClientInterface, ResetInterface
{
     ...
     */
    public function __construct(HttpClientInterface $client, ?RetryStrategyInterface $strategy = null, private int $maxRetries = 3, private ?LoggerInterface $logger = null)
    {
        $this->client = $client;
