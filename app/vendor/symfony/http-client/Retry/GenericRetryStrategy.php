 ...
 */
namespace Voxel\Vendor\Symfony\Component\HttpClient\Retry;
...
class GenericRetryStrategy implements RetryStrategyInterface
{
     ...
     */
    public function __construct(private array $statusCodes = self::DEFAULT_RETRY_STATUS_CODES, private int $delayMs = 1000, private float $multiplier = 2.0, private int $maxDelayMs = 0, private float $jitter = 0.1)
    {
        if ($delayMs < 0) {
