...
use Voxel\Vendor\Amp\CancellationToken;
use Voxel\Vendor\Amp\Deferred;
use Voxel\Vendor\Amp\Http\Client\Connection\ConnectionLimitingPool;
use Voxel\Vendor\Amp\Http\Client\Connection\DefaultConnectionFactory;
use Voxel\Vendor\Amp\Http\Client\InterceptedHttpClient;
use Voxel\Vendor\Amp\Http\Client\Interceptor\RetryRequests;
...
use Voxel\Vendor\Amp\Http\Tunnel\Https1TunnelConnector;
use Voxel\Vendor\Amp\Promise;
use Voxel\Vendor\Amp\Socket\Certificate;
use Voxel\Vendor\Amp\Socket\ClientTlsContext;
use Voxel\Vendor\Amp\Socket\ConnectContext;
use Voxel\Vendor\Amp\Socket\Connector;
use Voxel\Vendor\Amp\Socket\DnsConnector;
use Voxel\Vendor\Amp\Socket\SocketAddress;
...
final class AmpClientStateV4 extends ClientState
{
    ...
    public function __construct(?callable $clientConfigurator, private int $maxHostConnections, private int $maxPendingPushes, private ?LoggerInterface &$logger)
    {
