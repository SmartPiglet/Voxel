...
use Voxel\Vendor\Amp\Http\Client\ApplicationInterceptor;
use Voxel\Vendor\Amp\Http\Client\Connection\Connection;
use Voxel\Vendor\Amp\Http\Client\Connection\Stream;
use Voxel\Vendor\Amp\Http\Client\EventListener;
use Voxel\Vendor\Amp\Http\Client\NetworkInterceptor;
use Voxel\Vendor\Amp\Http\Client\Request;
use Voxel\Vendor\Amp\Http\Client\Response;
use Voxel\Vendor\Amp\Socket\InternetAddress;
...
class AmpListenerV5 implements EventListener
{
     ...
     */
    public function __construct(array &$info, private array $pinSha256, private \Closure $onProgress, private &$handle)
    {
