...
final class AsyncContext
{
     ...
     */
    public function __construct(?callable &$passthru, private HttpClientInterface $client, ResponseInterface &$response, array &$info, private $content, private int $offset)
    {
