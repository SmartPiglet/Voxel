...
use Voxel\Vendor\Symfony\Component\HttpClient\Chunk\ErrorChunk;
use Voxel\Vendor\Symfony\Component\HttpClient\Exception\ClientException;
use Voxel\Vendor\Symfony\Component\HttpClient\Exception\RedirectionException;
use Voxel\Vendor\Symfony\Component\HttpClient\Exception\ServerException;
use Voxel\Vendor\Symfony\Component\HttpClient\TraceableHttpClient;
use Voxel\Vendor\Symfony\Component\Stopwatch\StopwatchEvent;
use Voxel\Vendor\Symfony\Contracts\HttpClient\Exception\ClientExceptionInterface;
use Voxel\Vendor\Symfony\Contracts\HttpClient\Exception\RedirectionExceptionInterface;
use Voxel\Vendor\Symfony\Contracts\HttpClient\Exception\ServerExceptionInterface;
...
{
    public function __construct(private HttpClientInterface $client, private ResponseInterface $response, private mixed &$content = \false, private ?StopwatchEvent $event = null)
    {
    }
