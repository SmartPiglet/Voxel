...
use Voxel\Vendor\GuzzleHttp\Promise\Promise as GuzzlePromise;
use Voxel\Vendor\GuzzleHttp\Promise\RejectedPromise;
use Voxel\Vendor\GuzzleHttp\Promise\Utils;
use Voxel\Vendor\Http\Client\Exception\NetworkException;
use Voxel\Vendor\Http\Client\Exception\RequestException;
use Voxel\Vendor\Http\Client\HttpAsyncClient;
use Voxel\Vendor\Http\Discovery\Psr17Factory;
use Voxel\Vendor\Http\Discovery\Psr17FactoryDiscovery;
use Voxel\Vendor\Nyholm\Psr7\Factory\Psr17Factory as NyholmPsr17Factory;
use Voxel\Vendor\Nyholm\Psr7\Request;
use Voxel\Vendor\Nyholm\Psr7\Uri;
...
use Voxel\Vendor\Psr\Http\Message\ResponseInterface as Psr7ResponseInterface;
use Voxel\Vendor\Psr\Http\Message\StreamFactoryInterface;
use Voxel\Vendor\Psr\Http\Message\StreamInterface;
use Voxel\Vendor\Psr\Http\Message\UriFactoryInterface;
use Voxel\Vendor\Psr\Http\Message\UriInterface;
use Voxel\Vendor\Symfony\Component\HttpClient\Internal\HttplugWaitLoop;
use Voxel\Vendor\Symfony\Component\HttpClient\Response\HttplugPromise;
...
final class HttplugClient implements ClientInterface, HttpAsyncClient, RequestFactoryInterface, StreamFactoryInterface, UriFactoryInterface, ResetInterface
{
    ...
    {
        try {
            return HttplugWaitLoop::createPsr7Response($this->responseFactory, $this->streamFactory, $this->client, $this->sendPsr7Request($request), \true);
