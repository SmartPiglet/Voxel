...
{
    public function __construct(private ReflectionTypeResolver $reflectionTypeResolver, private TypeContextFactory $typeContextFactory)
    {
    }
    public function resolve(mixed $subject, ?TypeContext $typeContext = null): Type
    {
        ...
        try {
            ...
            $path = null !== $typeContext ? \sprintf('%s::%s($%s)', $typeContext->calledClassName, $subject->getDeclaringFunction()->getName(), $subject->getName()) : \sprintf('%s($%s)', $subject->getDeclaringFunction()->getName(), $subject->getName());
