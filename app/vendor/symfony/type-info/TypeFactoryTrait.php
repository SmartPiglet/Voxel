 ...
 */
namespace Voxel\Vendor\Symfony\Component\TypeInfo;

use Voxel\Vendor\Symfony\Component\TypeInfo\Type\ArrayShapeType;
...
use Voxel\Vendor\Symfony\Component\TypeInfo\Type\EnumType;
...
use Voxel\Vendor\Symfony\Component\TypeInfo\Type\TemplateType;
...
trait TypeFactoryTrait
{
    ...
    {
        return self::array($value, self::int(), asList: \true);
    }
    /**
     * @return CollectionType<BuiltinType<TypeIdentifier::ARRAY>>
     */
     ...
     */
    public static function arrayShape(array $shape, bool $sealed = \true, ?Type $extraKeyType = null, ?Type $extraValueType = null): ArrayShapeType
    {
        $shape = array_map(static function (array|Type $item): array {
            return $item instanceof Type ? ['type' => $item, 'optional' => \false] : ['type' => $item['type'], 'optional' => $item['optional'] ?? \false];
        }, $shape);
