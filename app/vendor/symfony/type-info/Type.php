...
use Voxel\Vendor\Symfony\Component\TypeInfo\Type\CompositeTypeInterface;
...
abstract class Type implements \Stringable
{
     ...
     */
    public function traverse(bool $traverseComposite = \true, bool $traverseWrapped = \true): iterable
    {
        yield $this;
