...
class CreateBusiness implements \JsonSerializable
{
    ...
    {
        return $this->filterUndefined(['name' => $this->name, 'company_number' => $this->companyNumber, 'tax_identifier' => $this->taxIdentifier, 'contacts' => $this->contacts, 'custom_data' => $this->customData]);
    }
}
