...
class UpdateDiscount implements \JsonSerializable
{
    ...
    {
        return $this->filterUndefined(['amount' => $this->amount, 'description' => $this->description, 'type' => $this->type, 'enabled_for_checkout' => $this->enabledForCheckout, 'code' => $this->code, 'currency_code' => $this->currencyCode, 'recur' => $this->recur, 'maximum_recurring_intervals' => $this->maximumRecurringIntervals, 'usage_limit' => $this->usageLimit, 'restrict_to' => $this->restrictTo, 'expires_at' => $this->expiresAt, 'status' => $this->status, 'custom_data' => $this->customData, 'mode' => $this->mode, 'discount_group_id' => $this->discountGroupId]);
    }
}
