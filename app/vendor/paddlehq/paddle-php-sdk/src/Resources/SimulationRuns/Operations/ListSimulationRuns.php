...
class ListSimulationRuns implements HasParameters
{
     ...
     */
    public function __construct(private readonly Pager|null $pager = null, private readonly array $ids = [], private readonly array $includes = [])
    {
    ...
    public function getParameters(): array
    {
        ...
        return array_merge($this->pager?->getParameters() ?? [], array_filter(['id' => implode(',', $this->ids), 'include' => implode(',', array_map($enumStringify, $this->includes))]));
    }
}
