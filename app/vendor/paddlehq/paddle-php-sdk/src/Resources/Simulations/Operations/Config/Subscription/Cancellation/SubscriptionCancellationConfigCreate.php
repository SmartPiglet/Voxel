...
class SubscriptionCancellationConfigCreate implements SimulationConfigCreate
{
    ...
    public function __construct(public readonly SubscriptionCancellationEntitiesCreate|Undefined $entities = new Undefined(), public readonly SubscriptionCancellationOptionsCreate|Undefined $options = new Undefined())
    {
    }
    ...
    {
        return ['subscription_cancellation' => (object) $this->filterUndefined(['entities' => $this->entities, 'options' => $this->options])];
    }
}
