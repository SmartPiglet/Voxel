...
namespace Voxel\Vendor\Paddle\SDK\Resources\PaymentMethods\Operations;
...
class ListPaymentMethods implements HasParameters
{
     ...
     */
    public function __construct(private readonly Pager|null $pager = null, private readonly array $addressIds = [], private readonly bool|null $supportsCheckout = null)
    {
    ...
    {
        return array_merge($this->pager?->getParameters() ?? [], array_filter(['address_id' => implode(',', $this->addressIds), 'supports_checkout' => isset($this->supportsCheckout) ? $this->supportsCheckout ? 'true' : 'false' : null]));
    }
}
