...
class SubscriptionNonCatalogPriceWithProduct
{
     ...
     */
    public function __construct(public string $description, public string|null $name, public SubscriptionNonCatalogProduct $product, public TaxMode $taxMode, public Money $unitPrice, public array $unitPriceOverrides, public PriceQuantity $quantity, public CustomData|null $customData, public TimePeriod|null $billingCycle = null, public TimePeriod|null $trialPeriod = null)
    {
    }
}
