...
use Voxel\Vendor\Paddle\SDK\Entities\SimulationType;
class SimulationTypeCollection extends Collection
{
    ...
    {
        return new self(array_map(fn(array $item): SimulationType => SimulationType::from($item), $itemsData), $paginator);
    }
