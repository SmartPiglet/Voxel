...
use Voxel\Vendor\Paddle\SDK\Entities\NotificationLog;
class NotificationLogCollection extends Collection
{
    ...
    {
        return new self(array_map(fn(array $item): NotificationLog => NotificationLog::from($item), $itemsData), $paginator);
    }
