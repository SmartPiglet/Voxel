...
{
    private function __construct(public string $customerAuthToken, public \DateTimeInterface $expiresAt)
    {
    }
    public static function from(array $data): self
    {
        return new self(customerAuthToken: $data['customer_auth_token'], expiresAt: DateTime::from($data['expires_at']));
    }
}
