...
{
    public function __construct(public string $priceId, public int $quantity, public bool|null $includeInTotals)
    {
    }
    public static function from(array $data): self
    {
        return new self($data['price_id'], $data['quantity'], $data['include_in_totals'] ?? null);
    }
}
