...
class TransactionNonCatalogPriceWithProduct
{
     ...
     */
    public function __construct(public string $description, public string|null $name, public TimePeriod|null $billingCycle, public TimePeriod|null $trialPeriod, public TaxMode $taxMode, public Money $unitPrice, public array $unitPriceOverrides, public PriceQuantity $quantity, public CustomData|null $customData, public TransactionNonCatalogProduct $product)
    {
    }
}
