...
use Voxel\Vendor\Paddle\SDK\Notifications\Entities\Address;
use Voxel\Vendor\Paddle\SDK\Notifications\Entities\Entity;
final class AddressCreated extends Event
{
    private function __construct(string $eventId, EventTypeName $eventType, \DateTimeInterface $occurredAt, public readonly Address $address, string|null $notificationId)
    {
