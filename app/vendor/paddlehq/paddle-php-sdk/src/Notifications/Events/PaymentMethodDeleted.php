...
use Voxel\Vendor\Paddle\SDK\Notifications\Entities\DeletedPaymentMethod;
use Voxel\Vendor\Paddle\SDK\Notifications\Entities\Entity;
final class PaymentMethodDeleted extends Event
{
    private function __construct(string $eventId, EventTypeName $eventType, \DateTimeInterface $occurredAt, public readonly DeletedPaymentMethod $paymentMethod, string|null $notificationId)
    {
