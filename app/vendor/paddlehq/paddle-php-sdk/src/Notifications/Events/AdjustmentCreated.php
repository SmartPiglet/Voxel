...
use Voxel\Vendor\Paddle\SDK\Notifications\Entities\Adjustment;
use Voxel\Vendor\Paddle\SDK\Notifications\Entities\Entity;
final class AdjustmentCreated extends Event
{
    private function __construct(string $eventId, EventTypeName $eventType, \DateTimeInterface $occurredAt, public readonly Adjustment $adjustment, string|null $notificationId)
    {
