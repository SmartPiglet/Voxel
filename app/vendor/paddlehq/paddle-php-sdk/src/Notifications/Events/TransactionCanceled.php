...
use Voxel\Vendor\Paddle\SDK\Notifications\Entities\Transaction;
final class TransactionCanceled extends Event
{
    private function __construct(string $eventId, EventTypeName $eventType, \DateTimeInterface $occurredAt, public readonly Transaction $transaction, string|null $notificationId)
    {
