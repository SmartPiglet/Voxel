...
use Voxel\Vendor\Paddle\SDK\Notifications\Entities\Subscription;
final class SubscriptionTrialing extends Event
{
    private function __construct(string $eventId, EventTypeName $eventType, \DateTimeInterface $occurredAt, public readonly Subscription $subscription, string|null $notificationId)
    {
