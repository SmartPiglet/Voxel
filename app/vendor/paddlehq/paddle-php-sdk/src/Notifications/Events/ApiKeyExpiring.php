...
use Voxel\Vendor\Paddle\SDK\Notifications\Entities\ApiKey;
use Voxel\Vendor\Paddle\SDK\Notifications\Entities\Entity;
final class ApiKeyExpiring extends Event
{
    private function __construct(string $eventId, EventTypeName $eventType, \DateTimeInterface $occurredAt, public readonly ApiKey $apiKey, string|null $notificationId)
    {
