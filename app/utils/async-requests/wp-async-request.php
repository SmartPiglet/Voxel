...
abstract class WP_Async_Request {
	...
	public function __construct() {
		...
		add_action( 'voxel_ajax_' . $this->identifier, array( $this, 'maybe_handle' ) );
		add_action( 'voxel_ajax_nopriv_' . $this->identifier, array( $this, 'maybe_handle' ) );
	}
