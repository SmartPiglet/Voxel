...
class Country_List {
	...
	public static function all() {
		return [
			...
			'AX' => [
				'name' => __( 'Aland Islands', 'voxel-countries' ),
				'alpha-2' => 'AX',
			],
			'AL' => [
			...
			'BS' => [
				'name' => __( 'Bahamas', 'voxel-countries' ),
				'alpha-2' => 'BS',
			],
			'BH' => [
			...
			'BQ' => [
				'name' => __( 'Bonaire, Saint Eustatius and Saba', 'voxel-countries' ),
				'alpha-2' => 'BQ',
			],
			'BA' => [
			...
			'BN' => [
				'name' => __( 'Brunei Darussalam', 'voxel-countries' ),
				'alpha-2' => 'BN',
			],
			'BG' => [
			...
			'CG' => [
				'name' => __( 'Congo', 'voxel-countries' ),
				'alpha-2' => 'CG',
			],
			'CD' => [
				'name' => __( 'Congo, Democratic Republic', 'voxel-countries' ),
				'alpha-2' => 'CD',
			],
			'CK' => [
			...
			'CI' => [
				'name' => __( 'Cote D\'Ivoire', 'voxel-countries' ),
				'alpha-2' => 'CI',
			],
			'HR' => [
			...
			'CW' => [
				'name' => __( 'Curacao', 'voxel-countries' ),
				'alpha-2' => 'CW',
			],
			'CY' => [
			...
			'FK' => [
				'name' => __( 'Falkland Islands (Malvinas)', 'voxel-countries' ),
				'alpha-2' => 'FK',
			],
			'FO' => [
			...
			'TF' => [
				'name' => __( 'French Southern Territories', 'voxel-countries' ),
				'alpha-2' => 'TF',
			],
			'GA' => [
			...
			'GM' => [
				'name' => __( 'Gambia', 'voxel-countries' ),
				'alpha-2' => 'GM',
			],
			'GE' => [
			...
			'HM' => [
				'name' => __( 'Heard Island & Mcdonald Islands', 'voxel-countries' ),
				'alpha-2' => 'HM',
			],
			'VA' => [
				'name' => __( 'Holy See (Vatican City State)', 'voxel-countries' ),
				'alpha-2' => 'VA',
			],
			'HN' => [
			...
			'IR' => [
				'name' => __( 'Iran, Islamic Republic Of', 'voxel-countries' ),
				'alpha-2' => 'IR',
			],
			'IQ' => [
			...
			'IE' => [
				'name' => __( 'Ireland', 'voxel-countries' ),
				'alpha-2' => 'IE',
			],
			'IM' => [
			...
			'XK' => [
				'name' => __( 'Kosovo', 'voxel-countries' ),
				'alpha-2' => 'XK',
			],
			'KW' => [
			...
			'LA' => [
				'name' => __( 'Lao People\'s Democratic Republic', 'voxel-countries' ),
				'alpha-2' => 'LA',
			],
			'LV' => [
			...
			'LY' => [
				'name' => __( 'Libyan Arab Jamahiriya', 'voxel-countries' ),
				'alpha-2' => 'LY',
			],
			'LI' => [
			...
			'MK' => [
				'name' => __( 'Macedonia', 'voxel-countries' ),
				'alpha-2' => 'MK',
			],
			'MG' => [
			...
			'FM' => [
				'name' => __( 'Micronesia, Federated States Of', 'voxel-countries' ),
				'alpha-2' => 'FM',
			],
			'MD' => [
			...
			'AN' => [
				'name' => __( 'Netherlands Antilles', 'voxel-countries' ),
				'alpha-2' => 'AN',
			],
			'NC' => [
			...
			'PS' => [
				'name' => __( 'Palestinian Territory, Occupied', 'voxel-countries' ),
				'alpha-2' => 'PS',
			],
			'PA' => [
			...
			'PN' => [
				'name' => __( 'Pitcairn', 'voxel-countries' ),
				'alpha-2' => 'PN',
			],
			'PL' => [
			...
			'RE' => [
				'name' => __( 'Reunion', 'voxel-countries' ),
				'alpha-2' => 'RE',
			],
			'RO' => [
			...
			'RU' => [
				'name' => __( 'Russian Federation', 'voxel-countries' ),
				'alpha-2' => 'RU',
			],
			'RW' => [
			...
			'BL' => [
				'name' => __( 'Saint Barthelemy', 'voxel-countries' ),
				'alpha-2' => 'BL',
			],
			'SH' => [
			...
			'VC' => [
				'name' => __( 'Saint Vincent And Grenadines', 'voxel-countries' ),
				'alpha-2' => 'VC',
			],
			'WS' => [
			...
			'ST' => [
				'name' => __( 'Sao Tome And Principe', 'voxel-countries' ),
				'alpha-2' => 'ST',
			],
			'SA' => [
			...
			'GS' => [
				'name' => __( 'South Georgia And Sandwich Isl.', 'voxel-countries' ),
				'alpha-2' => 'GS',
			],
			'KR' => [
			...
			'SY' => [
				'name' => __( 'Syrian Arab Republic', 'voxel-countries' ),
				'alpha-2' => 'SY',
			],
			'TW' => [
			...
			'TL' => [
				'name' => __( 'Timor-Leste', 'voxel-countries' ),
				'alpha-2' => 'TL',
			],
			'TG' => [
			...
			'UM' => [
				'name' => __( 'United States Outlying Islands', 'voxel-countries' ),
				'alpha-2' => 'UM',
			],
			'UY' => [
			...
			'VN' => [
				'name' => __( 'Viet Nam', 'voxel-countries' ),
				'alpha-2' => 'VN',
			],
			'VG' => [
